	...
	return (
        ...
        <div className="graphContainerCert" ref={containerRef}>
          <div className="certFlexDiv">
            <a href="https://www.credly.com/earner/earned/badge/fd660734-8fa0-4b83-888c-fa516e14c5db" target="_blank" rel="noreferrer noopener" title="AWS Certified Solutions Architect Associate">
