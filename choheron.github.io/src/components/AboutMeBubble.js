...
export default function AboutMeBubble(props) {
	...
	let aboutMeText = `	
	  I'm <b>Thomas Campbell</b>, a <i>Site Reliability Developer</i> based in Austin, TX. With a professional passion for Creation, Automation,
		...
		<br/><br/>
		I have focused on Agile principles with an emphasis on pipeline creation and refactoring 
